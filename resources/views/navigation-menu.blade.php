<nav x-data="{ open: false }" class="openMenu" style="margin-left:1.75rem;">
    <!-- Primary Navigation Menu -->
    <div class="primaryNavigationMenu">
        <div class="">
            <div class="flex">
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="openMenu1 hidden sm:hidden">
